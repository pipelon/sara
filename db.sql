...
CREATE TABLE `equine_variable_values` (
  ...
  KEY `idx_ev_equine_subcat_var` (`equine_id`,`subcategory_id`,`variable_id`),
  KEY `idx_ev_subcat_var` (`subcategory_id`,`variable_id`),
  KEY `idx_ev_equine_var` (`equine_id`,`variable_id`),
