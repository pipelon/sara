...
CREATE TABLE `categories` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de categorías de caballos';

/*Data for the table `categories` */

insert  into `categories`(`id`,`name`,`description`,`active`,`created`,`created_by`,`modified`,`modified_by`) values (1,'Geometría','Descripción de la categoría Geometría',1,'2025-09-01 21:02:57','pipe.echeverri','2025-09-01 21:03:07','pipe.echeverri'),(2,'Balance',NULL,1,'2025-09-02 21:41:17','pipe.echeverri','2025-09-02 21:41:17','pipe.echeverri');
