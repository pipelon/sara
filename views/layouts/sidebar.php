<aside class="main-sidebar sidebar-dark-warning elevation-4">
    <!-- Brand Logo -->
    <a href="<?= \Yii::$app->homeUrl; ?>" class="brand-link bg-warning">
        <?=
        \yii\helpers\Html::img("@web/images/SonrisaSmall.png",
                [
                    'alt' => 'Happiness Logo',
        ...
        ?>
        <span class="brand-text font-weight-light">Happiness Café</span>
    </a>
